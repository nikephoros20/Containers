...
TEST(Vector_Capacity, Size) {
  ...
  EXPECT_EQ(int_temp.size(), 0);
  EXPECT_EQ(int_temp2.size(), 2);
}
...
TEST(Vector_Modifiers, Pop_Back) {
  ...
  EXPECT_THROW(int_temp[2], std::out_of_range);
}
